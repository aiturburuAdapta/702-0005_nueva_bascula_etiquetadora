...
public class PesadaGestor {
    ...
    public Pesada TelegramaToPesada(String pTelegrama) throws Exception {
        ...
        if (!vPartes[0].equalsIgnoreCase(tramaAlive)) {
            ...
            // AGI: Tanto para el PID como para el MainPID, su parte tiene que ser exacta, pero el resto de la trama aparte de los identidficadores viene con información adicional. ¿Sería correcto por lo tanto usar contains en vez de equalsIgnoreCase?
